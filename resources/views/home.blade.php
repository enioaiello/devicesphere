            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <a href="{{ route('devices') }}"
                       class="block text-right text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 mt-4">
                        Tous les appareils
                    </a>
                </div>
                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    @else
                        <div class="mt-4 p-4 sm:p-8 bg-gray-100 dark:bg-gray-900 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                {{ __("Les appareils qui nécessitent une réparation s'afficheront ici.") }}
                            </p>
                        </div>
                    @endif
                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">
                        {{ __("Voici les prêts qui prendront bientôt fin.") }}
                    </p>
                    ...
                    @else
                        <div class="mt-4 p-4 sm:p-8 bg-gray-100 dark:bg-gray-900 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                {{ __("Les appareils que vous aurez prêtés s'afficheront ici.") }}
                            </p>
                        </div>
                    @endif
        ...
        <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">
                        {{ __("Voici les appareils que vous avez actuellement empruntés.") }}
                    </p>
                    ...
                    @else
                        <div class="mt-4 p-4 sm:p-8 bg-gray-100 dark:bg-gray-900 shadow sm:rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                {{ __("Les appareils que vous emprunterez apparaîtront ici.") }}
                            </p>
                        </div>
                    @endif
